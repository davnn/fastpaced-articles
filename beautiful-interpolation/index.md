...
![Interpolation and Extrapolation](interpolation-extrapolation.png){.width-medium .themed width=360 height=184 loading=eager}
...
![Example Points](example-data.png){.width-medium .themed width=360 height=238 loading=eager}
...
![Interpolating Polynomial of 3 Points](interpolating-polynomial.png){.width-medium .themed width=360 height=238 loading=lazy}
...
![Interpolating Polynomial of 10 Points](runge-phenomenon.png){.width-medium .themed width=360 height=215 loading=lazy}
...
![Linear Spline](linear-spline.png){.width-medium .themed width=360 height=238 loading=lazy}
...
![Quadratic Spline](quadratic-spline.png){.width-medium .themed width=360 height=238 loading=lazy}
...
![Cubic Spline](cubic-spline.png){.width-medium .themed width=360 height=238 loading=lazy}
